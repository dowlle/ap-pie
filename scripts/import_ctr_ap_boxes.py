...
HINTS: dict[tuple[str, int], str] = {
    ...
    ("Cortex Castle", 6): "On the walkway along the outside of the castle wall. The black area is the drop beside the walkway.",
    ("Cortex Castle", 7): "On the walkway along the outside of the castle wall. The black area is the drop beside the walkway.",
    ("Cortex Castle", 8): "On the walkway along the outside of the castle wall. The black area is the drop beside the walkway.",
    ("Cortex Castle", 9): "On the walkway along the outside of the castle wall. The black area is the drop beside the walkway.",
