...
GUIDES: list[dict[str, str]] = [
    {
        ...
        "page_title": "APWorld Fuzzer: Generation Badges and Results | Archipelago Pie",
        "meta_description": "Understand Tests pending, Generation passed and Generation warnings badges, raw fuzz verdicts, and recorded failure rates before your multiworld session.",
        "card_title": "What is the fuzzer?",
        "card_blurb": "Understand generation badges, detailed fuzz results and what the recorded checks can tell you.",
