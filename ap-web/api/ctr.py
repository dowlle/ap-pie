...
def ctr_releases_latest():
    # No release index yet: the bare path follows the newest release, so it
    # is a temporary redirect that moves on with every release.
    return redirect(f"/ctr/releases/{RELEASE_PAGES[0]['slug']}", code=302)
