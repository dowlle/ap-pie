...
/** Stand-in greyscale Archipelago mark — chain-link motif. The actual
 * archipelago.gg brand glyph is angular geometric letterforms; this
 * approximation reads thematically as "multiworld / linked seeds" and
 * inherits currentColor for the muted/accent-light hover pattern. Swap
 * for a brand-faithful path when we get a clean source. */
